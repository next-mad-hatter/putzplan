...
\begin{longtable}{p{4cm}gcgcgcgc}
  ...
  %\multirow{1}{*}{\bf KW} &
   &
  \rotatebox[origin=c]{42}{20. Juli --- 26. Juli} &
  \rotatebox[origin=c]{42}{27. Juli --- 2. Aug} &
  \rotatebox[origin=c]{42}{3. Aug --- 9. Aug} &
  \rotatebox[origin=c]{42}{10. Aug --- 16. Aug} &
  \rotatebox[origin=c]{42}{17. Aug --- 23. Aug} &
  \rotatebox[origin=c]{42}{24. Aug --- 30. Aug} &
  \rotatebox[origin=c]{42}{31. Aug --- 6. Sept} &
  \rotatebox[origin=c]{42}{7. Sept --- 13 Sept}
  \\
