...
\begin{longtable}{p{4cm}gcgcgcgc}
  ...
  %\multirow{1}{*}{\bf KW} &
   &
  \rotatebox[origin=c]{42}{11. Jan --- 17. Jan} &
  \rotatebox[origin=c]{42}{18. Jan --- 24. Jan} &
  \rotatebox[origin=c]{42}{25. Jan --- 31. Jan} &
  \rotatebox[origin=c]{42}{1. Feb --- 7. Feb} &
  \rotatebox[origin=c]{42}{8. Feb --- 14. Feb} &
  \rotatebox[origin=c]{42}{15. Feb --- 21. Feb} &
  \rotatebox[origin=c]{42}{22. Feb --- 28. Feb} &
  \rotatebox[origin=c]{42}{29. Feb --- 6. Mar}
  \\
